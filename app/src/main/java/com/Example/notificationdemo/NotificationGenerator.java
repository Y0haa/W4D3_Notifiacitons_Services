...
//      Uses the builder class to pull the layout of the notification bar and creates the notification
    public static void customBigNotification(Context context){

//        Intent intent = new Intent(context, MyService.class);
//        context.startService(intent);

        RemoteViews simpleView = new RemoteViews(context.getPackageName(), R.layout.big_notification);
...
/*
        ...
        Song = MediaPlayer.create(context, R.raw.music_batman);
        Song.start();
*/
...
//      Creates listeners that are binded to the buttons in the layout.
